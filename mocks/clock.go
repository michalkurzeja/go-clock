...
func (_m *Clock) AfterFunc(d time.Duration, f func()) clockwork.Timer {
	ret := _m.Called(d, f)
	...
	var r0 clockwork.Timer
	if rf, ok := ret.Get(0).(func(time.Duration, func()) clockwork.Timer); ok {
		r0 = rf(d, f)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(clockwork.Timer)
		}
	}
...
// Clock_AfterFunc_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AfterFunc'
type Clock_AfterFunc_Call struct {
	*mock.Call
}
...
//   - d time.Duration
//   - f func()
func (_e *Clock_Expecter) AfterFunc(d interface{}, f interface{}) *Clock_AfterFunc_Call {
	return &Clock_AfterFunc_Call{Call: _e.mock.On("AfterFunc", d, f)}
}

func (_c *Clock_AfterFunc_Call) Run(run func(d time.Duration, f func())) *Clock_AfterFunc_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Clock_AfterFunc_Call) Return(_a0 clockwork.Timer) *Clock_AfterFunc_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Clock_AfterFunc_Call) RunAndReturn(run func(time.Duration, func()) clockwork.Timer) *Clock_AfterFunc_Call {
	_c.Call.Return(run)
	return _c
}

// NewTicker provides a mock function with given fields: d
func (_m *Clock) NewTicker(d time.Duration) clockwork.Ticker {
	ret := _m.Called(d)
	...
	var r0 clockwork.Ticker
	if rf, ok := ret.Get(0).(func(time.Duration) clockwork.Ticker); ok {
		r0 = rf(d)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(clockwork.Ticker)
		}
	}
...
func (_c *Clock_NewTicker_Call) Return(_a0 clockwork.Ticker) *Clock_NewTicker_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Clock_NewTicker_Call) RunAndReturn(run func(time.Duration) clockwork.Ticker) *Clock_NewTicker_Call {
	_c.Call.Return(run)
	return _c
}

// NewTimer provides a mock function with given fields: d
func (_m *Clock) NewTimer(d time.Duration) clockwork.Timer {
	ret := _m.Called(d)
	...
	var r0 clockwork.Timer
	if rf, ok := ret.Get(0).(func(time.Duration) clockwork.Timer); ok {
		r0 = rf(d)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(clockwork.Timer)
...
func (_c *Clock_NewTimer_Call) Return(_a0 clockwork.Timer) *Clock_NewTimer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Clock_NewTimer_Call) RunAndReturn(run func(time.Duration) clockwork.Timer) *Clock_NewTimer_Call {
	_c.Call.Return(run)
	return _c
}
